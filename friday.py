...
def wish():
    ...
    if hour>=0 and hour<12:
        reply("Good Morning Hemanth!")
    elif hour>=12 and hour<18:
        reply("Good Afternoon Hemanth!")   
    else:
        reply("Good Evening Hemanth!")  
...
def respond(voice_data):
    ...
    if is_awake==False:
        ...
        reply('My name is friday i am build by Hemanth!')
    
    elif 'i love you' in voice_data:
        reply('I too love you Hemanth!')
        ...
        try:
            ...
            reply('This is what I found Hemanth')
        except:
            reply('Please check your Internet')

    elif 'explain' in voice_data:
        reply("don't warry Hemanth, I will explain for you!")
        ...
        reply("Good bye Hemanth! Have a nice day.")
        is_awake = False
